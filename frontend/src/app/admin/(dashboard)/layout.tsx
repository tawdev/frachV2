...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Sidebar - fixed */}
      <aside className="w-64 bg-primary text-white hidden md:flex flex-col fixed inset-y-0 left-0 z-30">
        ...
        <div className="p-4 border-t border-primary-light">
          ...
          <form action={logoutAdmin}>
            <button type="submit" className="flex w-full items-center gap-3 px-4 py-3 hover:bg-red-500/20 rounded-xl text-red-300 hover:text-red-400 transition-colors">
